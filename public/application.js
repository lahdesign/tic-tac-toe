...
module.exports = __webpack_require__.p + "db82dbbbbf3dc99185db62911afd9b00.jpg";
...
// choose user one
// ************************
var selectUserOne = document.querySelector('#userOne');

selectUserOne.onchange = function () {
  var choice = selectUserOne.value;
...
// choose user two
// ************************
var selectUserTwo = document.querySelector('#userTwo');

selectUserTwo.onchange = function () {
  var choice = selectUserTwo.value;
...
var userOne = '🌛';
var userTwo = '🌞';
var currentUser = userTwo;
var winner = '';
var scoreO = 0;
var scoreX = 0;
var executedScore = false;
...
var gameValues = {
  ...
  // Game play
  // ************************
};var playerMoves = $('.col1, .col2, .col3').click(function (square) {
...
var checkWinner = function checkWinner() {
  for (var i = 0; i <= 8; i++) {
    ...
    sq(num);
    // for horizantal rows
  }if (sq(0) !== '' && sq(0) === sq(1) && sq(1) === sq(2) || sq(3) !== '' && sq(3) === sq(4) && sq(4) === sq(5) || sq(6) !== '' && sq(6) === sq(7) && sq(7) === sq(8) || sq(0) !== '' && sq(0) === sq(3) && sq(3) === sq(6) || sq(1) !== '' && sq(1) === sq(4) && sq(4) === sq(7) || sq(2) !== '' && sq(2) === sq(5) && sq(5) === sq(8) || sq(0) !== '' && sq(0) === sq(4) && sq(4) === sq(8) || sq(6) !== '' && sq(6) === sq(4) && sq(4) === sq(2)) {
...
var displayCurrentUser = function displayCurrentUser(currentUser) {
...
// ************************
var score = function score(winner) {
...
// ************************
var clearBoard = function clearBoard(number) {
...
var onCreateGame = function onCreateGame(event) {
  ...
  api.createGame().then(ui.createSuccess).catch(ui.createSuccess);
};

var onMoves = function onMoves(event) {
  event.preventDefault();
  var data = game.gameValues;
  api.userMoves(data.i, data.v, data.isOver).then(ui.movesSuccess).catch(ui.movesSuccess);
};

var onGetGames = function onGetGames(event) {
  event.preventDefault();
  api.getGames().then(ui.getGamesSuccess).catch(ui.getGamesSuccess);
};
...
// imports
exports.push([module.i, "@import url(https://fonts.googleapis.com/css?family=Cardo|Cinzel|Glegoo|Josefin+Slab|Vidaloka);", ""]);
exports.push([module.i, "@import url(https://fonts.googleapis.com/css?family=Abel|Chathura|Economica|Khand|Open+Sans+Condensed:300|Pathway+Gothic+One);", ""]);
...
module.exports = __webpack_require__.p + "837a1473bd05f2824444ba09a1df7248.jpg";
